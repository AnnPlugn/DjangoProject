...
Добро пожаловать в наш проект **PharmaDB**! Это современное веб-приложение на основе Djangoъ. (Ранее pet-project Предсказание цен недвижимости в Москве). Проект использует Docker Compose для упрощения развертывания и PostgreSQL для надежного хранения данных. Присоединяйтесь к нам, чтобы упростить вашу работу с фармацевтическими данными!
...
Раздел для добавления, редактирования и просмотра данных о химических соединениях.

![Управление соединениями](screenshots/compounds_management.png)  
*Скриншот раздела управления соединениями, где можно добавлять и редактировать данные о веществах.*

### 3. Обучение моделей
Интерфейс для настройки и запуска обучения моделей машинного обучения для анализа свойств соединений.

![Обучение моделей](screenshots/model_training.png)  
*Скриншот раздела обучения моделей, показывающий настройки и прогресс обучения.*

### 4. Панель администратора
Административный интерфейс для управления пользователями, данными и настройками приложения.
